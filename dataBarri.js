...
module.exports.ROOMS = {
    ...
    barriEntrada: {
        ...
        things: {
            ...
            // you can use offset attribute to force the depthOffset for this thing (this doesn't take into account scale!)
    ...
    barriAula: {
        ...
        things: {
            // you can use scale attribute to force the scale for this thing
